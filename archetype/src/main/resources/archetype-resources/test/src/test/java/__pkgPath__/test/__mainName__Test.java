...
public class ${mainName}Test {
	...
	public void testClickOnButton(final FxRobot robot) {
		...
		// GIVEN
		final MenuBar menuBar = robot.lookup("${symbol_pound}menuBar").queryAs(MenuBar.class);
		assertThat(menuBar).isVisible();		

		// WHEN
		robot.clickOn("${symbol_pound}menuHelp");
        robot.clickOn("${symbol_pound}menuItemAbout");
